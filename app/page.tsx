...
export default function Home() {
  ...
  return (
    <div className="pt-6 mx-12">
      ...
      <main className="mt-6 py-10 bg-cyan-800 rounded-lg items-center flex flex-col justify-center gap-2">
      ...
      {data && (
        <main className="my-10 py-10 bg-cyan-800 rounded-lg items-start flex flex-col justify-start gap-2">
